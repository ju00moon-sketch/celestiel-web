...
const PILLARS = [
  {
    tag: 'TRUTH',
    title: '진실은 숨겨져 있지 않다',
    body: '1막 첫 화면의 지도부터 답을 보여준다 — 아무도 읽지 않을 뿐이다. 너무 완전한 원반, 오차 없는 태양, 게임 내내 노출되는 창세력 1347이라는 숫자. 진실은 반전이 아니라 재독(再讀)이다.',
  },
  {
    tag: 'KARMA',
    title: '모든 행동이 장부에 적힌다',
    body: '살생도, 발굴도, 진실을 찾으려는 행동조차 카르마로 기록된다. 카르마가 높은 자는 천사가 먼저 노린다 — 죄가 곧 어그로다. 그리고 인간과 마족의 장부는 하나다.',
  },
  {
    tag: 'WORLD SHIFT',
    title: '레이드가 세계를 영구히 바꾼다',
    body: '보스 격파는 보상이 아니라 사건이다. 서약이 끊기면 말하지 못하던 자가 마침내 말하고, 망각이 무너지면 마족 전체가 기억을 되찾는다. 되돌릴 수 없다.',
  },
  {
    tag: 'ASCENT',
    title: '하늘의 위계를 거슬러 오른다',
    body: '지상의 본편 5막이 끝나면, 천상 아이테리온을 한 층씩 올라가는 레이드가 시작된다. 천족의 계급 구조가 그대로 콘텐츠 티어다. 정점에는 한 번도 지상을 내려다본 적 없는 존재가 있다.',
  },
]
  ...
  return (
    <div className="wrap page">
      ...
      <p style={{ marginBottom: '38px' }}>
        <strong>당신은 이 세계가 무엇인지 묻게 된다.</strong> 그리고 이
        세계에는, 그 질문을 팔백 년째 기다려온 자가 있다.
      </p>
